...
const fileName = ref(props.project.attachment_path ? props.project.attachment_path.split('/').pop() : '');
const fileSize = ref('');
...
const submit = () => {
  form.post(route('client.proyek.update', props.project.id), {
    forceFormData: true
  });
};
</script>
...
<template>
  <ProfileLayout>
    <Head title="Edit Rincian Proyek" />
            ...
            <CardHeader class="pb-4">
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>Perbarui rincian spesifikasi desain bangunan Anda.</CardDescription>
                </div>
              </div>
            </CardHeader>
        ...
        <div class="space-y-6">
          ...
          <Card class="border-border/60 shadow-sm rounded-3xl overflow-hidden bg-white">
            <CardHeader class="pb-3">
              ...
              <CardDescription>Ganti atau tambahkan dokumen referensi.</CardDescription>
            </CardHeader>
            <CardContent class="space-y-4">
              <!-- Upload area -->
              <div v-if="!form.attachment && !fileName" 
                ...
                <span class="text-xs font-bold text-slate-700">Pilih File Baru</span>
