...
<aside class="bg-gray-900 text-white w-64 min-h-screen flex-shrink-0">
    <div class="p-6 border-b border-gray-800">
        ...
        <p class="text-gray-400 text-sm mt-1">{{ ucfirst($role) }} Panel</p>
    </div>

    <nav class="mt-6">
        @if ($role === 'arsitek')
            <a href="{{ route('dashboard.arsitek') }}" class="flex items-center px-6 py-3 {{ request()->routeIs('dashboard.arsitek') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
            ...
            <a href="#" class="flex items-center px-6 py-3 text-gray-400 hover:bg-gray-800 hover:text-white">
        ...
        @elseif ($role === 'perusahaan')
            <a href="{{ route('dashboard.perusahaan') }}" class="flex items-center px-6 py-3 {{ request()->routeIs('dashboard.perusahaan') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0h4"/></svg>
                Dashboard
            </a>
            <a href="#" class="flex items-center px-6 py-3 text-gray-400 hover:bg-gray-800 hover:text-white">
        ...
        @elseif ($role === 'client')
            <a href="{{ route('dashboard.client') }}" class="flex items-center px-6 py-3 {{ request()->routeIs('dashboard.client') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0h4"/></svg>
                Dashboard
            </a>
            <a href="#" class="flex items-center px-6 py-3 text-gray-400 hover:bg-gray-800 hover:text-white">
        ...
        @elseif ($role === 'admin')
            <a href="{{ route('dashboard.admin') }}" class="flex items-center px-6 py-3 {{ request()->routeIs('dashboard.admin') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0h4"/></svg>
                Dashboard
            </a>
            <a href="#" class="flex items-center px-6 py-3 text-gray-400 hover:bg-gray-800 hover:text-white">
